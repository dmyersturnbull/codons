...
In the case of structural complexity, we are interested in statistical associations that are potentially nonlinear. For this purpose we will use the Hilbert--Schmidt norm \cite{Song2012} \cite{Song2012a} \todo{Finish this paragraph [Douglas]} 
